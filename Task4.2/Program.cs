// Решение от GeekBrains (с одной, встроенной, функцией):
...
while (true) // Бесконечный цикл
{
    ...
    {
        int sum = 0;
        int tempNumber = number; // Используем временную переменную для вычислений

        while (tempNumber > 0) // Вычисление суммы цифр числа
        {
            sum += tempNumber % 10; // Добавление последней цифры к сумме
            tempNumber /= 10; // Удаление последней цифры из числа
        }
